...
public class TitleElement
{
    ...
    public static readonly DependencyProperty TitlePlacementProperty =
        DependencyProperty.RegisterAttached(
            "TitlePlacement",
            typeof(TitlePlacementType),
            typeof(TitleElement),
            new FrameworkPropertyMetadata(
                TitlePlacementType.Top,
    ...
    public static void SetTitleMargin(DependencyObject element, Thickness value) =>
        element.SetValue(TitleMarginProperty, value);

    public static Thickness GetTitleMargin(DependencyObject element) =>
        (Thickness)element.GetValue(TitleMarginProperty);
